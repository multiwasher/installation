...
const translationsData = {
    ...
    // 13 - CONSUMPTION
    "Cons_Tension_Tests": { pt: "Testes Tensão", en: "Tension in the tests (V)", es: "Pruebas tensión", fr: "Tests tension" },
    "Cons_Heater_1_Tank_A": { pt: "Aquecedor 1 Tanque (A)", en: "Consumption Heating Element 1 Tank (A)", es: "Calentador 1 tanque (A)", fr: "Radiateur 1 réservoir (A)" },
    "Cons_Heater_2_Tank_A": { pt: "Aquecedor 2 Tanque (A)", en: "Consumption Heating Element 2 Tank (A)", es: "Calentador 2 tanque (A)", fr: "Radiateur 2 réservoir (A)" },
    "Cons_Heater_3_Tank_A": { pt: "Aquecedor 3 Tanque (A)", en: "Consumption Heating Element 3 Tank (A)", es: "Calentador 3 tanque (A)", fr: "Radiateur 3 réservoir (A)" },
    "Cons_Heater_4_Tank_A": { pt: "Aquecedor 4 Tanque (A)", en: "Consumption Heating Element 4 Tank (A)", es: "Calentador 4 tanque (A)", fr: "Radiateur 4 réservoir (A)" },
    "Cons_Heater_Boiler_1_A": { pt: "Aquecedor Caldeira 1 (A)", en: "Consumption Heating Boiler 1 (A)", es: "Calentador caldeira 1 (A)", fr: "Radiateur chaudière 1 (A)" },
    "Cons_Heater_Boiler_2_A": { pt: "Aquecedor Caldeira 2 (A)", en: "Consumption Heating Boiler 2 (A)", es: "Calentador caldeira 2 (A)", fr: "Radiateur chaudière 2 (A)" },
    "Cons_Washing_Pump_A": { pt: "Bomba Lavagem (A)", en: "Washing pump consumption (A)", es: "Bomba lavado (A)", fr: "Pompe lavage (A)" },
    "Cons_Basket_Motor_4_Hz_A": { pt: "Motor Cesto 4 Hz (A)", en: "Cons. Basket Motor 4 Hz (A)", es: "Motor cesta 4 Hz (A)", fr: "Moteur panier 4 Hz (A)" },
    "Cons_Basket_Motor_80_Hz_A": { pt: "Motor Cesto 80 Hz (A)", en: "Cons. Basket Motor 80 Hz (A)", es: "Motor cesta 80 Hz (A)", fr: "Moteur panier 80 Hz (A)" },
    "Cons_Fan_A": { pt: "Ventilador (A)", en: "Fan Consumption (A)", es: "Ventilador (A)", fr: "Ventilateur (A)" },
    "Cons_Rising_Pump_A": { pt: "Bomba Elevação (A)", en: "Consumption Rising Pump (A)", es: "Bomba elevación (A)", fr: "Pompe relevage (A)" },
    "Temp_Confirm_Tank": { pt: "Temperatura Confirmação Tanque", en: "Temperature confirmation Tank (°C/ °F)", es: "Confirmação temperatura tanque", fr: "Confirmation température réservoir" },
    "Temp_Confirm_Boiler": { pt: "Temperatura Confirmação Caldeira", en: "Boiler Temperature confirmation (°C/ °F)", es: "Confirmação temperatura caldeira", fr: "Confirmation température chaudière" },
    "Relay_Supervision_Regulation_A": { pt: "Relé Supervisão Regulação (A)", en: "Supervision of the rising pump (A)", es: "Relé supervisión regulación (A)", fr: "Relais supervision régulation (A)" },
    "Thermal_Reg_Rinsing_Pump_A": { pt: "Regulação Térmica Bomba Enxague (A)", en: "Thermal regulation of the rinsing pump (A)", es: "Reg. térmica bomba enjuague (A)", fr: "Régulation thermique pompe rinçage (A)" },
    "Thermal_Reg_Fan_A": { pt: "Regulação Térmica Ventilador (A)", en: "Fan termal regulation (A)", es: "Reg. térmica ventilador (A)", fr: "Régulation thermique ventilateur (A)" },
    "Thermal_Variable_Speed_Drive_A_P305": { pt: "Accionamiento Velocidad Variable (A) P305", en: "Thermal variable speed drive control [P305] (A)", es: "Accionamiento velocidad variable (A) P305", fr: "Entraînement vitesse variable (A) P305" },
    "Washing_Pressure": { pt: "Pressão Lavagem", en: "Washing pressure", es: "Presión lavado", fr: "Pression lavage" },
    "Cons_Total_Consumption_In_Operation_A": { pt: "Consumo Total em operação (A)", en: "Total Consumption in operation (A)", es: "Consumo total en funcionamiento (A)", fr: "Consommation totale en fonctionnement (A)" },
    
    // 13.1 - CONSUMPTION MEASUREMENTS
    "Tension_Tests_Value": { pt: "Tensão Testes (V)", en: "Tension in the tests (V)", es: "Tensión pruebas (V)", fr: "Tension tests (V)" },
    "ConsMeas_R4_Phase1": { pt: "R4 Fase 1", en: "R4 Phase 1", es: "R4 Fase 1", fr: "R4 Phase 1" },
    "ConsMeas_R4_Phase2": { pt: "R4 Fase 2", en: "R4 Phase 2", es: "R4 Fase 2", fr: "R4 Phase 2" },
    "ConsMeas_R4_Phase3": { pt: "R4 Fase 3", en: "R4 Phase 3", es: "R4 Fase 3", fr: "R4 Phase 3" },
    "ConsMeas_R5_Phase1": { pt: "R5 Fase 1", en: "R5 Phase 1", es: "R5 Fase 1", fr: "R5 Phase 1" },
    "ConsMeas_R5_Phase2": { pt: "R5 Fase 2", en: "R5 Phase 2", es: "R5 Fase 2", fr: "R5 Phase 2" },
    "ConsMeas_R5_Phase3": { pt: "R5 Fase 3", en: "R5 Phase 3", es: "R5 Fase 3", fr: "R5 Phase 3" },
    "ConsMeas_R6_Phase1": { pt: "R6 Fase 1", en: "R6 Phase 1", es: "R6 Fase 1", fr: "R6 Phase 1" },
    "ConsMeas_R6_Phase2": { pt: "R6 Fase 2", en: "R6 Phase 2", es: "R6 Fase 2", fr: "R6 Phase 2" },
    "ConsMeas_R6_Phase3": { pt: "R6 Fase 3", en: "R6 Phase 3", es: "R6 Fase 3", fr: "R6 Phase 3" },
    "ConsMeas_R7_Phase1": { pt: "R7 Fase 1", en: "R7 Phase 1", es: "R7 Fase 1", fr: "R7 Phase 1" },
    "ConsMeas_R7_Phase2": { pt: "R7 Fase 2", en: "R7 Phase 2", es: "R7 Fase 2", fr: "R7 Phase 2" },
    "ConsMeas_R7_Phase3": { pt: "R7 Fase 3", en: "R7 Phase 3", es: "R7 Fase 3", fr: "R7 Phase 3" },
    "ConsMeas_R2_Phase1": { pt: "R2 Fase 1", en: "R2 Phase 1", es: "R2 Fase 1", fr: "R2 Phase 1" },
    "ConsMeas_R2_Phase2": { pt: "R2 Fase 2", en: "R2 Phase 2", es: "R2 Fase 2", fr: "R2 Phase 2" },
    "ConsMeas_R2_Phase3": { pt: "R2 Fase 3", en: "R2 Phase 3", es: "R2 Fase 3", fr: "R2 Phase 3" },
    "ConsMeas_R3_Phase1": { pt: "R3 Fase 1", en: "R3 Phase 1", es: "R3 Fase 1", fr: "R3 Phase 1" },
    "ConsMeas_R3_Phase2": { pt: "R3 Fase 2", en: "R3 Phase 2", es: "R3 Fase 2", fr: "R3 Phase 2" },
    "ConsMeas_R3_Phase3": { pt: "R3 Fase 3", en: "R3 Phase 3", es: "R3 Fase 3", fr: "R3 Phase 3" },
    "ConsMeas_M1_Pump_Phase1": { pt: "M1 Bomba Fase 1", en: "M1 Pump Phase 1", es: "M1 Bomba Fase 1", fr: "M1 Pompe Phase 1" },
    "ConsMeas_M1_Pump_Phase2": { pt: "M1 Bomba Fase 2", en: "M1 Pump Phase 2", es: "M1 Bomba Fase 2", fr: "M1 Pompe Phase 2" },
    "ConsMeas_M1_Pump_Phase3": { pt: "M1 Bomba Fase 3", en: "M1 Pump Phase 3", es: "M1 Bomba Fase 3", fr: "M1 Pompe Phase 3" },
    "ConsMeas_M11_4Hz_Phase1": { pt: "M11 4Hz Fase 1", en: "M11 4Hz Phase 1", es: "M11 4Hz Fase 1", fr: "M11 4Hz Phase 1" },
    "ConsMeas_M11_4Hz_Phase2": { pt: "M11 4Hz Fase 2", en: "M11 4Hz Phase 2", es: "M11 4Hz Fase 2", fr: "M11 4Hz Phase 2" },
    "ConsMeas_M11_4Hz_Phase3": { pt: "M11 4Hz Fase 3", en: "M11 4Hz Phase 3", es: "M11 4Hz Fase 3", fr: "M11 4Hz Phase 3" },
    "ConsMeas_M11_80Hz_Phase1": { pt: "M11 80Hz Fase 1", en: "M11 80Hz Phase 1", es: "M11 80Hz Fase 1", fr: "M11 80Hz Phase 1" },
    "ConsMeas_M11_80Hz_Phase2": { pt: "M11 80Hz Fase 2", en: "M11 80Hz Phase 2", es: "M11 80Hz Fase 2", fr: "M11 80Hz Phase 2" },
    "ConsMeas_M11_80Hz_Phase3": { pt: "M11 80Hz Fase 3", en: "M11 80Hz Phase 3", es: "M11 80Hz Fase 3", fr: "M11 80Hz Phase 3" },
    "ConsMeas_M10_Fan_Phase1": { pt: "M10 Ventilador Fase 1", en: "M10 Fan Phase 1", es: "M10 Ventilador Fase 1", fr: "M10 Ventilateur Phase 1" },
    "ConsMeas_M10_Fan_Phase2": { pt: "M10 Ventilador Fase 2", en: "M10 Fan Phase 2", es: "M10 Ventilador Fase 2", fr: "M10 Ventilateur Phase 2" },
    "ConsMeas_M10_Fan_Phase3": { pt: "M10 Ventilador Fase 3", en: "M10 Fan Phase 3", es: "M10 Ventilador Fase 3", fr: "M10 Ventilateur Phase 3" },
    "ConsMeas_Rising_Pump_Phase1": { pt: "Bomba Elevação Fase 1", en: "Rising Pump Phase 1", es: "Bomba Elevación Fase 1", fr: "Pompe Relevage Phase 1" },
    "ConsMeas_Rising_Pump_Phase2": { pt: "Bomba Elevação Fase 2", en: "Rising Pump Phase 2", es: "Bomba Elevación Fase 2", fr: "Pompe Relevage Phase 2" },
    "ConsMeas_Rising_Pump_Phase3": { pt: "Bomba Elevação Fase 3", en: "Rising Pump Phase 3", es: "Bomba Elevación Fase 3", fr: "Pompe Relevage Phase 3" },
    "ConsMeas_Total_Phase1": { pt: "Total Fase 1", en: "Total Phase 1", es: "Total Fase 1", fr: "Total Phase 1" },
    "ConsMeas_Total_Phase2": { pt: "Total Fase 2", en: "Total Phase 2", es: "Total Fase 2", fr: "Total Phase 2" },
    "ConsMeas_Total_Phase3": { pt: "Total Fase 3", en: "Total Phase 3", es: "Total Fase 3", fr: "Total Phase 3" },
    "ConsMeas_Temp_Tank_Machine": { pt: "Máquina (°C/°F)", en: "Machine (°C/°F)", es: "Máquina (°C/°F)", fr: "Machine (°C/°F)" },
    "ConsMeas_Temp_Tank_Multimeter": { pt: "Multímetro (°C/°F)", en: "Multimeter (°C/°F)", es: "Multímetro (°C/°F)", fr: "Multimètre (°C/°F)" },
    "ConsMeas_Temp_Boiler_Machine": { pt: "Máquina (°C/°F)", en: "Machine (°C/°F)", es: "Máquina (°C/°F)", fr: "Machine (°C/°F)" },
    "ConsMeas_Temp_Boiler_Multimeter": { pt: "Multímetro (°C/°F)", en: "Multimeter (°C/°F)", es: "Multímetro (°C/°F)", fr: "Multimètre (°C/°F)" },
    "ConsMeas_Supervision_Min": { pt: "Mínimo", en: "Minimum", es: "Mínimo", fr: "Minimum" },
    "ConsMeas_Supervision_Max": { pt: "Máximo", en: "Maximum", es: "Máximo", fr: "Maximum" },
    "ConsMeas_Variable_Speed_Value": { pt: "Valor", en: "Value", es: "Valor", fr: "Valeur" },
    "ConsMeas_Washing_Pressure_Value": { pt: "Valor (bar/PSI)", en: "Value (bar/PSI)", es: "Valor (bar/PSI)", fr: "Valeur (bar/PSI)" },
    "ConsMeas_Thermal_R4_Value": { pt: "R4 Térmicos", en: "R4 Thermics", es: "R4 Térmicos", fr: "R4 Thermiques" },
    "ConsMeas_Thermal_R5_Value": { pt: "R5 Térmicos", en: "R5 Thermics", es: "R5 Térmicos", fr: "R5 Thermiques" },
    "ConsMeas_Thermal_R6_Value": { pt: "R6 Térmicos", en: "R6 Thermics", es: "R6 Térmicos", fr: "R6 Thermiques" },
    "ConsMeas_Thermal_R7_Value": { pt: "R7 Térmicos", en: "R7 Thermics", es: "R7 Térmicos", fr: "R7 Thermiques" },
    "ConsMeas_Thermal_R2_Value": { pt: "R2 Térmicos", en: "R2 Thermics", es: "R2 Térmicos", fr: "R2 Thermiques" },
    "ConsMeas_Thermal_R3_Value": { pt: "R3 Térmicos", en: "R3 Thermics", es: "R3 Térmicos", fr: "R3 Thermiques" },
